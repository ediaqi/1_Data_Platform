...
from constants import FROST_SERVER
...
def display_header():
    st.set_page_config(
            page_title="EDIAQI Upload Page",
            page_icon="./images/favicon.ico",
            layout="wide")
    c1, _, _, _, _, _, _, c8 = st.columns(8)
    c1.image('./images/ediaqi-logo-light.svg')
    c8.image('./images/atl.site.png')
    # st.title('Welcome to EDIAQI Project!')
    st.markdown(f'__Here you can upload data to *[FROST server]({FROST_SERVER})*.__')
